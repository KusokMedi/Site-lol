...
export default function Services() {
  ...
  return (
    <AnimatedSection id="services" className="relative py-32">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[200px] bg-accent-600/3 rounded-full blur-[100px]" />
        <div className="absolute inset-0 grid-pattern opacity-15" />
        <div className="absolute top-0 left-1/4 right-1/4 h-px bg-gradient-to-r from-transparent via-accent-400/15 to-transparent" />
      </div>
