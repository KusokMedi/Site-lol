      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 mt-2 py-2 rounded-xl bg-dark-800/95 backdrop-blur-xl border border-white/[0.08] shadow-2xl min-w-[140px] z-50 overflow-hidden"
          >
            {[
              ...
              <motion.button
                key={item.code}
                onClick={() => { setLang(item.code as "en" | "ru"); setIsOpen(false); }}
